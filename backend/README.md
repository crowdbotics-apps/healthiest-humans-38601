...
## Project Structure
    ...
    ├── healthiest_humans_38601  # Django project configurations
...
1. Clone this repo and `cd healthiest_humans_38601`
...
2. Clone this repo and `cd healthiest_humans_38601`
