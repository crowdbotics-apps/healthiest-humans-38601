"""
Django settings for healthiest_humans_38601 project.
...
ROOT_URLCONF = 'healthiest_humans_38601.urls'
...
WSGI_APPLICATION = 'healthiest_humans_38601.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthiest_humans_38601 API",
    "DESCRIPTION": "API documentation for healthiest_humans_38601 App",
    "VERSION": "v1",
}
